...
public class ControladorDevolucion {
    ...
    public ControladorDevolucion(VistaDevolucionPrestamo miVista, VistasPrestamos miVistaTxt, PrestamoDAO modelo, EquipoDAO modeloE) {
        ...
        jTextObservaciones = this.miVista.txtObserva();
    ...
    public void buscarUnSoloEquipo(){
        
        ArrayList<Prestamo> miPrestamoUnico;
        miPrestamoUnico = modelo.listadoPrestamo(jTextBusquedad.getText());
        limpiarListadoTabla();
        cargarPrestamos(miPrestamoUnico);
    ...
    private void borrar() {
        ...
        if (codigo.isEmpty()) {
            ...
            int respuesta = JOptionPane.showConfirmDialog(null,
                    "¿Desea devolver el equipo de codigo : "
                    + codigo + " ?",
    ...
    private void actualizar() {
        ...
        equipo.setCodigoEquipo(jTextBusquedad.getText());
        equipo.setEstado(jTextObservaciones.getText());
        equipo.setUbicacionActual("Empresa");

        if (modeloE.modificarEstadoEquipo(equipo) == 1) {
            miVista.gestionMensajes(
                    "Se ha modificado el estado actual del equipo",
                    "Confirmación ",
                    JOptionPane.INFORMATION_MESSAGE);

            ArrayList<Equipo> listadoequipos;
            listadoequipos = modeloE.listadoEquipos("0");
